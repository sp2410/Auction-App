...
var AuctionSocket = function(user_id, auction_id, form) {
  ...
  //this.socket = new WebSocket("ws://www.tdcautoauction.com:80/" + "auctions/" + this.auction_id);
  //this.socket = new WebSocket("ws://localhost:3000/" + "auctions/" + this.auction_id);
...
$( document ).ready(function() {
    ...
    // $(".video-container").css({'height':($(".headerdiv").height()+'px')});
...
function initMap() {     
        ...
        var json = <%= raw @productsonauctionmap.to_json %>;  
